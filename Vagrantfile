...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  vmname = 'mujin'
  # BOX name and url
  if ENV['MUJIN_RECRUITING']=='bionic'
    vmname = 'buster'
    config.vm.box = "ubuntu/bionic64"
    config.vm.box_url = "https://atlas.hashicorp.com/ubuntu/boxes/bionic64"
    ...
    config.vm.box_url = "https://atlas.hashicorp.com/debian/boxes/stretch64"
  else
